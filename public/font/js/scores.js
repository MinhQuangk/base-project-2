function scoresFunc(evt, scoresName) {
    var i, s_tabcontent, s_tablinks;
    s_tabcontent = document.getElementsByClassName("scores_tabcontent");
    ...
    document.getElementById(scoresName).style.display = "block";
