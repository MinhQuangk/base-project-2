...
function expensesFunc(evt, expensesName) {
    var i, s_tabcontent, s_tablinks;
    s_tabcontent = document.getElementsByClassName("expenses_tabcontent");
    ...
    document.getElementById(expensesName).style.display = "block";
