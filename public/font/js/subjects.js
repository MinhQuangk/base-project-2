...
function subjectsFunc(evt, subjectsName) {
    var i, s_tabcontent, s_tablinks;
    s_tabcontent = document.getElementsByClassName("subjects_tabcontent");
    ...
    document.getElementById(subjectsName).style.display = "block";
